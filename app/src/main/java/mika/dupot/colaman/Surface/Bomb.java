...
public class Bomb extends GameObject {
    ...
    public Bomb(GameSurface gameSurface, Bitmap image, String color_, int widthGame,float scaledDensity, int x, int y) {
        super(image, 1, 8, x, y);
    ...
    public void draw(Canvas canvas) {
        ...
        //Log.i("Bomb draw","draw x:"+x2);
        //Log.i("Bomb draw","draw y:"+y2);
